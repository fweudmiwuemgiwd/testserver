...
echo -e "     ${c_blue}https://${DISPLAY_HOST}:${APP_PORT}/setup${c_off}"
echo "       (the panel serves its own TLS with a self-signed certificate;"
echo "        accept the browser warning once. To use a real certificate,"
echo "        put Caddy/nginx in front and run: sudo rvg tls off)"
echo ""
